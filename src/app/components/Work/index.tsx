    ...
    <Section className={styles.workWrapper}>
      <>
        ...
        <p>
          ...
          about the non-proprietary aspects of the work or the apps are internal
          enterprise level apps that companies use as their competitive
          ...
          decisions that were made, as well as learnings and outcomes from those
          projects.
        </p>
      </>
    </Section>
